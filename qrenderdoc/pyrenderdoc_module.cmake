set(MODULE_NAME pyrenderdoc_module)
...
set(SOURCES
    ...
    # ${CMAKE_CURRENT_SOURCE_DIR}/Code/pyrenderdoc/renderdoc_module_python.cxx
)
...
# 添加构建前执行的命令
set(swig_output ${CMAKE_CURRENT_BINARY_DIR}/generated/pyrenderdoc)
...
set(MACHINE_INDEPENDENT_GENERATED_SOURCE_FILES
    ${swig_output}/${SWIG_FILE_NAME}_python.cxx
)
