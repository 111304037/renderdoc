...
set CMAKE_BUILD_CMD=cmake -DBUILD_ANDROID=On -DANDROID_BUILD_TOOLS_VERSION=29.0.2 -DCMAKE_BUILD_TYPE=Debug -DGIT_HASH=1.36 -DBRANCH_DEV=On -GNinja -DGEN_GRADLE=On -DBRANCH_DEV=On

rem 设置 abi 数组
set abis[0]=armeabi-v7a
set abis[1]=arm64-v8a
set archs[0]=arm32
set archs[1]=arm64

@REM set abis[2]=x86
@REM set abis[3]=x86_64
@REM set archs[2]=x86
@REM set archs[3]=x86_64
